...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            while (true) {
                ...
                } catch (EmployeeNotFoundException | DatabaseException | IllegalArgumentException e) {
    ...
    static void add(Scanner s) {
        ...
        System.out.print("Type (FULL_TIME/CONTRACT): ");
        ...
        double de = Double.parseDouble(s.nextLine());
        Employee e = new Employee(0, n, em, d, t, b, a, de, LocalDate.now());
        System.out.println("Created employee ID: " + employees.add(e));
    }

    static void view(Scanner s) {
        System.out.print("Employee ID: ");
        System.out.println(employees.get(Integer.parseInt(s.nextLine())));
    }
    ...
    static void update(Scanner s) {
        ...
        employees.updateSalary(id, b, a, d);
        System.out.println("Salary updated.");
    }

    static void delete(Scanner s) {
        System.out.print("Employee ID: ");
        employees.delete(Integer.parseInt(s.nextLine()));
    ...
    static void markAttendance(Scanner s) {
        ...
        attendance.mark(new Attendance(id, date, st));
    ...
    static void applyLeave(Scanner s) {
        ...
        LocalDate a = LocalDate.parse(s.nextLine());
        System.out.print("End date: ");
        LocalDate b = LocalDate.parse(s.nextLine());
        System.out.print("Reason: ");
        String r = s.nextLine();
        leaves.apply(new LeaveRequest(id, a, b, r, "PENDING"));
    ...
    static void generatePayroll(Scanner s) {
        ...
        System.out.print("Payroll month (YYYY-MM): ");
        String m = s.nextLine();
    ...
    static void demo() {
        ...
        System.out.printf("Attendance-adjusted salary: %.2f%n",
                PayrollCalculator.calculateAttendanceAdjusted(e, 22, 24));
    }
}
